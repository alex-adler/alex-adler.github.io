...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h48480e626170194a: (a: number, b: number) => void;
export const closure8_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure175_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8eb9f6e49e3186f9: (a: number, b: number) => void;
export const closure1217_externref_shim: (a: number, b: number, c: any) => void;
export const closure1457_externref_shim: (a: number, b: number, c: any) => void;
