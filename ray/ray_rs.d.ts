...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he472a0bd9c3e9a1f: (a: number, b: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3ac6bbe374bd433e: (a: number, b: number) => void;
  readonly closure2743_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2825_externref_shim: (a: number, b: number, c: any) => void;
