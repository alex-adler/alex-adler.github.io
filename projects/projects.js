...
class Project {
    constructor(name, childrenOrState) {
        this.isOpen = false;
        this.name = name;
        // Default value
    ...
    draw(parentX, parentY) {
        ...
        // Draw containing box
        this.path.rect(parentX + this.x - this.textMeasurements.actualBoundingBoxLeft * 1.1, parentY + this.y - this.textMeasurements.actualBoundingBoxAscent * 1.2, (this.textMeasurements.actualBoundingBoxLeft + this.textMeasurements.actualBoundingBoxRight) * 1.1, (this.textMeasurements.actualBoundingBoxAscent + this.textMeasurements.actualBoundingBoxDescent) * 1.4);
        ctx.fill(this.path);
        if (this.isOpen) {
