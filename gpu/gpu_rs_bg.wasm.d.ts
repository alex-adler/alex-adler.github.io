...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h00cbb66bf57a7684: (a: number, b: number) => void;
export const closure13_externref_shim: (a: number, b: number, c: any) => void;
export const closure11_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure183_externref_shim: (a: number, b: number, c: any) => void;
export const closure2338_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcbc958b76f896d06: (a: number, b: number) => void;
export const closure2423_externref_shim: (a: number, b: number, c: any) => void;
