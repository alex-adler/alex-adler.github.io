...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hab1463a2eb7c44d2: (a: number, b: number) => void;
export const closure233_externref_shim: (a: number, b: number, c: any) => void;
export const closure2389_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2473_externref_shim: (a: number, b: number, c: any) => void;
