...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd83d0def3a8aec11: (a: number, b: number) => void;
export const closure49_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure589_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2739_externref_shim: (a: number, b: number, c: any) => void;
