...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7a02d39fd12032b4: (a: number, b: number) => void;
...
export const closure2545_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2630_externref_shim: (a: number, b: number, c: any) => void;
