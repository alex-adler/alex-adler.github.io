...
class Celestial {
	...
	GM_km3_s2: number;
	GM_km3_s2_primary: number; //Gravitational parameter for the body that this body orbits
	...
	setPhysicalParameters(GM_km3_s2_primary: number, GM_km3_S2: number, radius_km: number) {
